...
class CheckLoginNotSuccessMonkeyTest {
    companion object {
        private const val MOCK_USERNAME = "wrongtest@test.com"
    ...
    fun runMonkeyTest() {
        ...
        usernameField.text = MOCK_USERNAME
        passwordField.text = MOCK_PASSWORD
        ...
        assertTrue("Login failed", logoutButton == null)
    }
}
